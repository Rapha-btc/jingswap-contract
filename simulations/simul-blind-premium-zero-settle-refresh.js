// simul-blind-premium-zero-settle-refresh.js
...
//
// Run: npx tsx simulations/simul-blind-premium-zero-settle-refresh.js
...
async function main() {
  ...
  let source = fs.readFileSync("./contracts/blind-premium-zero.clar", "utf8");
  source = source
    .replace(
