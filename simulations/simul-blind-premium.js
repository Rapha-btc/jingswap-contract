// simul-blind-premium.js
// Stxer mainnet fork simulation: full blind-premium lifecycle
// Uses blind-premium-stxer.clar with zeroed block thresholds + relaxed staleness.
// Tests the premium clearing price (oracle * (1 - 20bps)) and per-depositor limits.
//
// Run: npx tsx simulations/simul-blind-premium.js
...
async function main() {
  ...
  console.log("1.  Deploy blind-premium (zeroed block thresholds)");
