...
(define-constant DEPOSIT_MIN_BLOCKS u0) ;; min 10 blocks before deposits can be closed (~70s)
...
(define-constant CANCEL_THRESHOLD u0)    ;; 42 blocks after closed = anyone can cancel (~5 min)
...
;; Safety gates
(define-constant MAX_STALENESS u999999999)      ;; price must be < 80s old
